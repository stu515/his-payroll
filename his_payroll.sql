CREATE DATABASE  IF NOT EXISTS `his_payroll` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `his_payroll`;
...
CREATE TABLE `employee_table` (
  ...
  CONSTRAINT `employee_fk2` FOREIGN KEY (`employee_cat`) REFERENCES `salary_rate` (`employee_cat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-03-15 15:29:07
